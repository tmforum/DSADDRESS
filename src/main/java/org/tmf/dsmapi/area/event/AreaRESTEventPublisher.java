...
@Stateless
@Asynchronous
public class AreaRESTEventPublisher implements AreaRESTEventPublisherLocal {
    ...
    public void publish(Hub hub, AreaEvent event) {
        ...
        List<AreaEvent> resultList = null;
        resultList = eventFacade.findByCriteria(query, AreaEvent.class);
