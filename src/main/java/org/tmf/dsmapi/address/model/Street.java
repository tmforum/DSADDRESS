 ...
 *         &lt;element name="characteristic" type="{http://orange.com/api/addressManagement/tmf/v1/model/business}Characteristic" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    @JoinColumn(name = "CHARACTERISTIC_STREET_ID")
    ...
    @JoinColumn(name = "ADDRESS_STREET_HJID")
    ...
    @JoinColumn(name = "AREA_STREET_HJID")
