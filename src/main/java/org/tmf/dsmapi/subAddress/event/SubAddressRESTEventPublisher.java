...
@Stateless
@Asynchronous
public class SubAddressRESTEventPublisher implements SubAddressRESTEventPublisherLocal {
    ...
    public void publish(Hub hub, SubAddressEvent event) {
        ...
        List<SubAddressEvent> resultList = null;
        resultList = eventFacade.findByCriteria(query, SubAddressEvent.class);
